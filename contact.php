				...
				<?php 
					...
					<form action="proses-komentar.php" method="post">
						<table class="table table-hover">
							<tr>
								<td>nama
								<input type="nama" name="nama" class="form-control input-md" placeholder="Isikan nama anda dengan lengkap" required>
								</td>
							</tr>
							<tr>
								<td>email
							...
							<tr>
								<td>no-handphone
								<input type="number" name="nohandphone" class="form-control input-md" placeholder="Isikan No Handphone yang masih aktif" required>
								</td>
							</tr>
							<tr>
								<td>pesan
